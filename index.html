...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="./assets/librairies/font-awesome-4.7.0/css/font-awesome.min.css"
    />
  </head>
  ...
  <body id="body">
    <nav id="nav">
      <div
        ...
        id="menuBurger"
      >
        <span style="font-size: 3em" id="croixMenu">&#9776;</span
        ><span style="font-size: 3em; display: none" id="croixMenu2"
          >&#10006;</span
      ...
      <div>
        <span>
          <a
            ...
            href="mailto:kevin.zubrzycki@gmail.com"
            >kevin.zubrzycki@gmail.com</a
          >
        </span>
      </div>
    </div>
    ...
    <div id="debut-contenu">
      ...
      <div class="contenu-page" id="a_propos">
        ...
        <div style="display: flex; justify-content: center; margin-top: 100px">
          <div
            style="background-color: green; width: 400px; height: 500px"
          ></div>
          <div>
      ...
      <div class="contenu-page" id="projets">
        ...
        >
          <div
            class="container-projet"
            onmouseover="reductionImagePi()"
            onmouseout="resetImagePi()"
          >
            <div>
          ...
          <div
            class="container-projet"
            onmouseover="reductionImageMontauban()"
            onmouseout="resetImageMontauban()"
          >
            <div>
              <img
                src="./assets/logo/logo-montauban-modif.jpg"
                id="img-montauban"
              />
            </div>
            <div id="les-pi">
              ...
              <ul class="contact-list">
                <li class="list-item">
                  <i class="fa fa-map-marker fa-2x"
                    ><span class="contact-text place">Ribérac, France</span></i
                  >
                </li>
